...
parser.add_argument('-i', '--nii_path', type=str, default='data3/autopet/images', help='path to the nii images')
parser.add_argument('-gt', '--gt_path', type=str, default='data3/autopet/labels', help='path to the ground truth',)
parser.add_argument('-o', '--npz_path', type=str, default='data3/Npz_files', help='path to save the npz files')
